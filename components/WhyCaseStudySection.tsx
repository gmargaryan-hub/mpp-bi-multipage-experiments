...
export default function WhyCaseStudySection() {
  return (
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        >
          <div className="p-8 md:p-10">
            ...
            <div className="flex flex-wrap items-center gap-x-10 gap-y-5 mb-6 px-6 py-6 rounded-2xl bg-[#F5F7FA] border border-[#E2E8F0]">
          ...
          {/* Dashboard screenshot — last, per the requested order. Container aspect ratio
              matches the image exactly (1280x600), so it displays with no cropping and no
              distortion. Width capped to keep it sharp on high-DPI displays (see Home
              page's case study for why — same fix applied here). */}
