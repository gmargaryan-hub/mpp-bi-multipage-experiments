    ...
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <SimpleCTASection
          ...
          body="We'll review your data, your environment, and how your team will use MPP BI. Then we'll recommend the right setup and the right number of seats, so you start with exactly what you need. For larger teams or more complex deployments, we'll prepare a package and pricing based on your requirements."
